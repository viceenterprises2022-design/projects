...
| `cryptopanic_cli.py` | **CryptoPanic CLI News Reader**. Token-free decryption-based CLI news reader for CryptoPanic. Supports interactive TUI dashboard and non-interactive Rich tables, with currency, sentiment, and search filtering. |
