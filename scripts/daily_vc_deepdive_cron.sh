#!/bin/bash
# daily_vc_deepdive_cron.sh — daily cron task to fetch VC deals and send to Slack
set -e
...
./venv/bin/python send_slack.py --webhook-url "https://hooks.slack.com/services/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" --file vc-deepdive/daily_vc_deepdive_report.md
