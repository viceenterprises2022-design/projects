...
```bash
curl -X POST http://localhost:8080/api/v1/execute/hello-reasoner.demo_echo \
...
```bash
curl -X POST http://localhost:8080/api/v1/execute/hello-reasoner.demo_analyze_sentiment \
  -H "Content-Type: application/json" \
...
Created by Vinod Reddy (vice.enterprises2022@gmail.com) on 2026-05-18 13:21:23 IST
