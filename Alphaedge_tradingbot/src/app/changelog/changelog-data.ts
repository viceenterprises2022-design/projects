...
//  - New entries are DRAFTS. Nothing reaches users until the desk operator
//    publishes it from /changelog. Give every entry a stable `id`; it is the
//    publication key, so editing an id un-publishes the entry.

export type ChangeTag = 'New' | 'Improved' | 'Risk control' | 'Fixed' | 'Evaluated';

export interface ChangeEntry {
  id: string;     // stable slug — NEVER change once published, it is the publish key
...
export const CHANGELOG: ChangeEntry[] = [
  ...
  {
    date: '2026-07-25',
    id: 'gold-lane-replaces-the-demo-tile',
    tag: 'New',
  ...
  {
    date: '2026-07-25',
    id: 'loss-stop-now-reopens-on-a-rolling-24-hours',
    tag: 'Risk control',
  ...
  {
    date: '2026-07-25',
    id: 'strategy-analytics-opened-to-everyone',
    tag: 'New',
  ...
  {
    date: '2026-07-25',
    id: 'equity-curve-now-readable-point-by-point',
    tag: 'Improved',
  ...
  {
    date: '2026-07-25',
    id: 'the-trading-day-now-rolls-at-00-00-utc',
    tag: 'Improved',
  ...
  {
    date: '2026-07-25',
    id: 'profit-ceiling-could-release-itself-mid-day',
    tag: 'Fixed',
  ...
  {
    date: '2026-07-24',
    id: 'automatic-daily-loss-stop-on-every-level',
    tag: 'Risk control',
  ...
  {
    date: '2026-07-24',
    id: 'individual-markets-can-now-be-paused',
    tag: 'Risk control',
  ...
  {
    date: '2026-07-24',
    id: 'higher-daily-trade-allowances',
    tag: 'Improved',
  ...
  {
    date: '2026-07-24',
    id: 'counter-trend-entry-filter-tested-and-rejected',
    tag: 'Evaluated',
  ...
  {
    date: '2026-07-23',
    id: 'service-interruption-resolved',
    tag: 'Fixed',
  ...
  {
    date: '2026-07-21',
    id: 'buy-and-sell-replace-yes-and-no',
    tag: 'Improved',
  ...
  {
    date: '2026-07-21',
    id: 'return-on-capital-shown-on-every-level',
    tag: 'New',
  ...
  {
    date: '2026-07-21',
    id: 'self-service-access-requests',
    tag: 'New',
