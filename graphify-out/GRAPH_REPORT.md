...
## Corpus Check
- 135 files · ~360,386 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1084 nodes · 2386 edges · 75 communities detected
- Extraction: 58% EXTRACTED · 42% INFERRED · 0% AMBIGUOUS · INFERRED: 1008 edges (avg confidence: 0.69)
...
Cohesion: 0.03
Nodes (33): place_market_buy(), place_market_sell(), PolymarketClient, api(), BotConfig, execution(), exit(), market_filters() (+25 more)
...
Cohesion: 0.04
Nodes (27): analyze(), fmt_telegram(), print_report(), analysis.py — Read results.tsv and surface insights. Usage:     python analysis., send_tg(), GammaClient, Run full TradingAgents pipeline for one copy signal concurrently., TaskAgent (+19 more)
...
Cohesion: 0.05
Nodes (47): DiskCache, Archive, decide(), git(), git_commit(), git_revert(), init_results(), log_result() (+39 more)
...
## Knowledge Gaps
- **107 isolated node(s):** `Fresh Telegram Integration Client.     Handles sending formatted messages and do`, `Send a text message to the configured chat.`, `Formats and sends a trading report.`, `Ingest equity data from Yahoo Finance.`, `Fetch fundamental data.` (+102 more)
...
- **Why does `main()` connect `Community 1` to `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 9`, `Community 10`, `Community 17`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `TelegramJournal` connect `Community 3` to `Community 4`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `merge_quotes_for_asset()` connect `Community 5` to `Community 9`, `Community 4`, `Community 6`?**
